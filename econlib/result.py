...
class Result:
    ...
    def summary(self, robust=False, tol=4):
        ...
        robust : boolean, optional
            True if robust standard error. Defaults to False.
        tol : int, optional
            the degree of precision. Defaults to 4.
        """
        if robust:
        ...
        table.add_column('standard_error', standard_error)
